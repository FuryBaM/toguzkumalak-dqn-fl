...
import typing
__all__: list[str] = ['BLACK', 'Board', 'EvalParams', 'GAME_BLACK_WIN', 'GAME_CONTINUE', 'GAME_DRAW', 'GAME_WHITE_WIN', 'GOAL', 'GameResult', 'GameState', 'Player', 'WHITE', 'ai_turn', 'check_winner', 'evaluate', 'find_best_move', 'get_eval_params', 'is_valid_move', 'legal_moves_count', 'make_move', 'renderBoard', 'set_eval_params']
class Board:
...
class Player:
    ...
    def value(self) -> int:
        ...
def ai_turn(state: GameState, max_depth: typing.SupportsInt = 8, time_limit_s: typing.SupportsFloat = 1.5) -> bool:
    ...
...
def legal_moves_count(state: GameState, player: typing.SupportsInt) -> int:
    ...
def make_move(state: GameState, x: typing.SupportsInt) -> bool:
    ...
def renderBoard(state: GameState) -> None:
    ...
