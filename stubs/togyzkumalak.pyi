...
import typing
__all__: list[str] = ['BLACK', 'Board', 'EvalParams', 'GAME_BLACK_WIN', 'GAME_CONTINUE', 'GAME_DRAW', 'GAME_WHITE_WIN', 'GOAL', 'GameResult', 'GameState', 'Move', 'Player', 'SearchParams', 'WHITE', 'ai_turn', 'check_winner', 'evaluate', 'find_best_move', 'gen_moves', 'get_eval_params', 'is_valid_move', 'legal_moves_count', 'make_move', 'mcts_search', 'move_to_string', 'render_board', 'set_eval_params']
class Board:
    @typing.overload
...
class SearchParams:
    ...
    def cpuct(self) -> float:
        ...
    @cpuct.setter
    def cpuct(self, arg0: typing.SupportsFloat) -> None:
        ...
    @property
    def dirichlet_alpha(self) -> float:
        ...
    @dirichlet_alpha.setter
    def dirichlet_alpha(self, arg0: typing.SupportsFloat) -> None:
        ...
    @property
    def dirichlet_eps(self) -> float:
        ...
    @dirichlet_eps.setter
    def dirichlet_eps(self, arg0: typing.SupportsFloat) -> None:
        ...
    @property
    def num_reads(self) -> int:
        ...
    @num_reads.setter
    def num_reads(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
...
def find_best_move(state: GameState, max_depth: typing.SupportsInt = 8, time_limit_s: typing.SupportsFloat = 1.5) -> tuple[int, int]:
    ...
def gen_moves(state: GameState) -> list[int]:
    ...
...
def make_move(state: GameState, x: typing.SupportsInt) -> Move:
    ...
def mcts_search(state: GameState, predictor: collections.abc.Callable, params: SearchParams = ...) -> tuple:
    ...
